    ...
    <div>
      <div>
        <div className="text-left mt-7 pr-5 ml-7 max-w-[600px] ">
          <h4 data-aos="fade-up" className="text-1xl font-bold">Danh mục thịnh hành</h4>
        </div>
        <div>
           {error && (
          ...
          <div  className="grid grid-cols-1 sm:grid-cols-3  lg:grid-cols-5 place-items-center mt-5 ">
            {categories.slice(0,5).map((categories, idx)=>
            <div
                data-aos="zoom-in"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-2 place-items-center justify-center mt-5 mx-auto w-fit p-4 ">
            {products.slice(0,2).map((products, idx)=>
             <div
            data-aos="zoom-in"
            data-aos-delay={idx * 100}
             className="w-125 bg-gray-100 rounded-2xl p-4 flex flex-col items-center relative shadow-md hover:shadow-lg transition-shadow duration-200 mr-10 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-lg font-semibold text-gray-800 mb-3">
                  Giá khởi điểm: <span className="text-[#333]">{products.price}</span>
                </div>
              </div>
              <button
                className="!bg-[#F09728] text-white text-sm px-4 py-1 !rounded-full mb-4 hover:scale-105 transition-transform duration-200"
              >
                Mua ngay
              </button>
