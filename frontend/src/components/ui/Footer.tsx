  ...
  <footer className=" text-gray-700 px-6 py-8">
      <div className="flex flex-col md:flex-row md:justify-center md:gap-x-8">
        ...
        <div className="flex-1">    
          <h3 className="text-lg font-bold" style={{ color: '#444444' }}>LIÊN HỆ</h3>
           <ul className="space-y-2 text-1xl  pt-1 pl-0 font-bold">
            ...
            <li style={{  color:"#A4A4A4" }}>123 Đường số 4 Phường 5 Quận 6</li>
            <li style={{ color:"#A4A4A4" }}>Thành Phố Thủ Đức</li>
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-2 text-1xl  pt-1 pl-0 font-bold">
            <li style={{  color:"#A4A4A4" }}>Các bên liên kết</li>
            <li style={{  color:"#A4A4A4" }}>Thông tin sản phẩm</li>
            <li style={{  color:"#A4A4A4" }}>Các bên liên kết</li>
          </ul>
        </div>
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-2 text-1xl  pt-1 pl-0 font-bold">
            <li style={{  color:"#A4A4A4" }}>Giải đáp thắc mắc</li>
            <li style={{  color:"#A4A4A4" }}>Liên hệ trực tuyến</li>
            <li style={{  color:"#A4A4A4" }}>Điều khoản & Quy định</li>
          </ul>
        </div>
        <div className="flex-1">
          <h3 className="text-lg font-bold" style={{ color: '#444444' }}>VỀ CHÚNG TÔI</h3>
          <ul className="space-y-2 text-1xl pt-1 pl-0 font-bold">
            <li style={{  color:"#A4A4A4" }}>Giới Thiệu</li>
            <li style={{  color:"#A4A4A4" }}>Tin Tức</li>
            <li style={{  color:"#A4A4A4" }}>Liên Hệ</li>
          </ul>
        </div>
      </div>
